...
> **Moved (2026-06-02).** The detailed Phase B roadmap — per-item designs,
...
>
> Shipped AI-native primitives are tracked in
> [`CHANGELOG.md`](../CHANGELOG.md) and the README
> "Recently shipped" / "In flight" sections.
